...
class AbilitiesRegistry:
    ...
    def _register_all_abilities(self):
        ...
        self._register(
            ...
            AbilityInfo(
                ...
                tier=1,
                tier_name="Cognitive Core",
                category="CORE",
                description="Decomposes problems into explicit intermediate steps",
                power_score=95,
                module="cognitive_core",
                tags=["cot", "step-by-step", "accuracy"],
            ),
        )
        self._register(
            "react_loop",
            AbilityInfo(
                ...
                tier_name="Cognitive Core",
                category="CORE",
                description="Think → Act → Observe iterative cycle",
                power_score=98,
                module="cognitive_core",
                tags=["react", "grounded", "iterative"],
            ),
        )
        self._register(
            "tree_of_thought",
            AbilityInfo(
                name="Tree-of-Thought Planning",
                tier=1,
                tier_name="Cognitive Core",
                category="ADVANCED",
                description="Explores multiple reasoning branches with backtracking",
                power_score=92,
                module="cognitive_core",
                tags=["tot", "branching", "backtrack"],
            ),
        )
        self._register(
            "self_consistency",
            AbilityInfo(
                ...
                tier_name="Cognitive Core",
                category="ADVANCED",
                description="Multi-path consensus voting for reliable answers",
                power_score=89,
                module="cognitive_core",
                tags=["cot-sc", "consensus", "reliability"],
            ),
        )
        ...
        self._register(
            ...
            AbilityInfo(
                ...
                tier=2,
                tier_name="Memory Systems",
                category="MEMORY",
                description="Stores and retrieves records of past interactions",
                power_score=88,
                module="memory",
                tags=["past-events", "rag", "vector-db"],
            ),
        )
        self._register(
            "semantic_knowledge",
            AbilityInfo(
                ...
                tier_name="Memory Systems",
                category="MEMORY",
                description="Persistent structured repository of domain facts",
                power_score=91,
                module="vector_memory",
                tags=["knowledge-graph", "facts", "domain"],
            ),
        )
        self._register(
            "procedural_skills",
            AbilityInfo(
                name="Procedural Skill Cache",
                tier=2,
                tier_name="Memory Systems",
                category="MEMORY",
                description="Reusable procedures for multi-step sequences",
                power_score=85,
                module="skill_acquisition",
        ...
        self._register(
            ...
            AbilityInfo(
                ...
                tier_name="Memory Systems",
                category="MEMORY",
                description="Intelligent context trimming and compression",
                power_score=83,
                module="context_manager",
                tags=["compression", "summarization", "context"],
            ),
        )
        ...
        self._register(
            ...
            AbilityInfo(
                ...
                tier=3,
                tier_name="Perception",
                category="SENSE",
                description="Process text, images, PDFs, audio in unified context",
                power_score=97,
                module="vision_analysis",
                enabled=settings.enable_vision,
                tags=["vision", "audio", "documents"],
            ),
        )
        self._register(
            "web_search",
            AbilityInfo(
                ...
                tier_name="Perception",
                category="SENSE",
                description="Queries live internet data with source attribution",
                power_score=94,
                module="mcp_integration",
                tags=["live-data", "grounding", "citations"],
            ),
        )
        self._register(
            ...
            AbilityInfo(
                ...
                tier_name="Perception",
                category="SENSE",
                description="Parses PDFs, spreadsheets, code repos with semantic understanding",
                power_score=90,
        ...
        self._register(
            ...
            AbilityInfo(
                ...
                tier_name="Perception",
                category="SENSE",
                description="Monitors system state, file changes, API responses",
                power_score=86,
                module="environment_sensing",
        ...
        self._register(
            ...
            AbilityInfo(
                ...
                tier=4,
                tier_name="Tool Use & Action",
                category="ACTION",
                description="Writes, runs, debugs code in sandboxed environments",
                power_score=99,
                module="persistent_shell",
                tags=["python", "sandbox", "debug"],
            ),
        )
        self._register(
            "browser_automation",
            AbilityInfo(
                ...
                tier_name="Tool Use & Action",
                category="ACTION",
                description="Navigates, clicks, fills forms, extracts data from web",
                power_score=93,
                module="browser_skill",
                tags=["playwright", "scraping", "web-ui"],
            ),
        )
        self._register(
            "mcp_integration",
            AbilityInfo(
                ...
                tier_name="Tool Use & Action",
                category="ACTION",
                description="Universal connector to external systems via MCP standard",
                power_score=96,
                module="mcp_integration",
                tags=["mcp", "apis", "plug-and-play"],
            ),
        )
        self._register(
            "database_ops",
            AbilityInfo(
                ...
                tier_name="Tool Use & Action",
                category="ACTION",
                description="SQL, NoSQL, vector DB operations autonomously",
                power_score=87,
                module="database_ops",
                enabled=settings.enable_database_ops,
                tags=["sql", "vector-db", "crud"],
            ),
        )
        ...
        self._register(
            ...
            AbilityInfo(
                ...
                tier=5,
                tier_name="Multi-Agent Orchestration",
                category="SWARM",
                description="Dynamically creates specialized child agents in parallel",
                power_score=100,
                module="sub_agents",
                enabled=settings.enable_sub_agents,
                tags=["parallel", "delegation", "scale"],
            ),
        )
        self._register(
            ...
            AbilityInfo(
                ...
                tier_name="Multi-Agent Orchestration",
                category="SWARM",
                description="Orchestrates teams of specialist agents in concert",
                power_score=98,
                module="sub_agents",
                enabled=settings.enable_sub_agents,
                tags=["orchestration", "specialist"],
            ),
        )
        self._register(
            "a2a_protocol",
            AbilityInfo(
                ...
                tier_name="Multi-Agent Orchestration",
                category="SWARM",
                description="Structured inter-agent messaging via A2A standard",
                power_score=91,
                module="a2a_protocol",
                enabled=settings.enable_swarm,
                tags=["a2a", "messaging", "discovery"],
            ),
        )
        self._register(
            "swarm_intelligence",
            AbilityInfo(
                ...
                tier_name="Multi-Agent Orchestration",
                category="SWARM",
                description="Decentralized agent cluster with emergent behavior",
                power_score=94,
                module="swarm_intelligence",
                enabled=settings.enable_swarm,
                tags=["emergent", "decentralized", "resilient"],
            ),
        )
        ...
        self._register(
            ...
            AbilityInfo(
                ...
                tier=6,
                tier_name="Autonomy & Self-Improvement",
                category="ELITE",
                description="Iterates on code until goal is fully met (Ralph pattern)",
                power_score=97,
                module="autonomous_loop",
                tags=["ralph", "self-debug", "loop"],
            ),
        )
        self._register(
            "evaluator_optimizer",
            AbilityInfo(
                ...
                tier_name="Autonomy & Self-Improvement",
                category="ELITE",
                description="Generate → Critique → Refine quality assurance loop",
                power_score=93,
                module="autonomous_loop",
                tags=["self-critique", "refinement", "quality"],
            ),
        )
        self._register(
            "skill_acquisition",
            AbilityInfo(
                name="Dynamic Skill Acquisition",
                tier=6,
                tier_name="Autonomy & Self-Improvement",
                category="ELITE",
                description="Discovers, learns, and activates new capability modules",
                power_score=89,
                module="skill_acquisition",
                enabled=settings.enable_skill_learning,
                tags=["skills-api", "marketplace", "extensible"],
            ),
        )
        self._register(
            "rl_feedback",
            AbilityInfo(
                name="RL Feedback Traces",
                tier=6,
                tier_name="Autonomy & Self-Improvement",
                category="ELITE",
                description="Learns from decision outcomes via reinforcement signals",
                power_score=88,
                module="rl_feedback",
                enabled=settings.enable_rl_feedback,
                tags=["rl", "learning", "continuous"],
            ),
        )
        ...
        self._register(
            ...
            AbilityInfo(
                ...
                tier=7,
                tier_name="Safety & Governance",
                category="SAFE",
                description="Pauses for human approval before high-stakes actions",
                power_score=85,
                module="governance",
                enabled=settings.enable_human_gate,
                tags=["approval", "interrupt", "high-stakes"],
            ),
        )
        self._register(
            "audit_trail",
            AbilityInfo(
                ...
                tier_name="Safety & Governance",
                category="SAFE",
                description="Logs every decision with timestamps and full context",
                power_score=90,
                module="governance",
                enabled=settings.enable_audit_trail,
                tags=["opentelemetry", "audit", "tracing"],
            ),
        )
        self._register(
            "sandbox",
            AbilityInfo(
                ...
                tier_name="Safety & Governance",
                category="SAFE",
                description="Runs code in isolated containers with resource limits",
                power_score=88,
                module="governance",
                enabled=settings.enable_sandbox,
                tags=["isolation", "containers", "resource-limits"],
            ),
        )
        self._register(
            "kill_switch",
            AbilityInfo(
                ...
                tier_name="Safety & Governance",
                category="SAFE",
                description="Emergency halt with state preservation and rollback",
                power_score=86,
                module="governance",
                enabled=settings.enable_kill_switch,
                tags=["emergency-stop", "rollback", "state-save"],
            ),
        )
    ...
    def get_dashboard(self) -> str:
        ...
        lines = [
            ...
            "╠══════════════════════════════════════════════════════════╣",
            (
                f"║  Total Abilities: {status['total_abilities']:>3}"
                f"    Enabled: {status['enabled_abilities']:>3}"
                "              ║"
            ),
            (
                f"║  Power Tiers: {status['total_tiers']}"
                f"        Avg Power: {status['average_power_score']:.0f}"
                "             ║"
            ),
        ...
        for tier_key, tier_data in status["tiers"].items():
            ...
            for ability in tier_data["abilities"]:
                ...
                lines.append(
                    f"║    {status_icon} {ability['name']:<40} P:{ability['power_score']:>3} ║"
                )
