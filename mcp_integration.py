...
class MCPIntegration:
    ...
    def _register_default_tools(self):
        ...
        self.register_tool(ToolDefinition(
            ...
            parameters={
                ...
                "language": {"type": "string", "description": "Filter by language", "optional": True},
        ...
        self.register_tool(ToolDefinition(
            ...
            parameters={
                ...
                "wait_for": {"type": "string", "description": "CSS selector to wait for", "optional": True}
            },
        ...
        self.register_tool(ToolDefinition(
            ...
            parameters={
                "session_id": {"type": "string", "description": "Session ID from shell_session_create"},
                "command": {"type": "string", "description": "Command to execute"},
                "timeout": {"type": "number", "description": "Command timeout in seconds", "optional": True, "default": 30}
            },
        ...
        self.register_tool(ToolDefinition(
            ...
            parameters={
                "image_path": {"type": "string", "description": "Path to image file (must be within the screenshots data directory)"},
                "prompt": {"type": "string", "description": "Analysis question or prompt"},
                "quality": {"type": "string", "description": "Quality level: fast, good, high, excellent", "default": "fast"}
            },
        ...
        self.register_tool(ToolDefinition(
            ...
            parameters={
                "image_path": {"type": "string", "description": "Path to UI screenshot or mockup (must be within the screenshots data directory)"},
                "focus_areas": {"type": "array", "description": "Areas to focus on (optional)", "optional": True}
            },
        ...
        self.register_tool(ToolDefinition(
            ...
            parameters={
                ...
                "workflow": {"type": "string", "description": "ComfyUI workflow name", "optional": True, "default": "default"},
                "reference_image": {"type": "string", "description": "Path to reference image (optional)", "optional": True},
                "width": {"type": "integer", "description": "Image width", "optional": True, "default": 512},
                "height": {"type": "integer", "description": "Image height", "optional": True, "default": 512}
            },
        ...
        self.register_tool(ToolDefinition(
            ...
            parameters={
                ...
                "provider": {"type": "string", "description": "Provider: minimax or comfyui", "optional": True},
                "duration": {"type": "number", "description": "Video duration in seconds (if supported)", "optional": True},
                "width": {"type": "integer", "description": "Video width", "optional": True},
                "height": {"type": "integer", "description": "Video height", "optional": True},
                "fps": {"type": "integer", "description": "Frames per second", "optional": True}
            },
        ...
        self.register_tool(ToolDefinition(
            ...
            parameters={
                ...
                "provider": {"type": "string", "description": "Provider: google_lyria, minimax, or comfyui", "optional": True},
                "durationSeconds": {"type": "number", "description": "Desired duration in seconds (may be ignored by some providers)", "optional": True},
                "genre": {"type": "string", "description": "Music genre (optional)", "optional": True},
                "mood": {"type": "string", "description": "Music mood (optional)", "optional": True},
                "tempo": {"type": "string", "description": "Tempo: slow, medium, fast (optional)", "optional": True}
            },
        ...
        self.register_tool(ToolDefinition(
            ...
            parameters={
                ...
                "num_results": {"type": "integer", "description": "Number of results to return", "optional": True, "default": 5},
                "search_type": {"type": "string", "description": "Type of search: web, news, images (default: web)", "optional": True, "default": "web"}
            },
        ...
        self.register_tool(ToolDefinition(
            ...
            parameters={
                ...
                "temperature": {"type": "number", "description": "Temperature (0-1)", "optional": True},
                "tools_enabled": {"type": "array", "description": "List of enabled tools", "optional": True},
                "memory_isolated": {"type": "boolean", "description": "Use isolated memory", "optional": True, "default": True}
            },
        ...
        self.register_tool(ToolDefinition(
            ...
            parameters={
                "template_name": {"type": "string", "description": "Template name: coder, researcher, writer, or analyst"},
                "custom_name": {"type": "string", "description": "Custom profile name", "optional": True}
            },
        ...
        self.register_tool(ToolDefinition(
            ...
            parameters={
                ...
                "script_content": {"type": "string", "description": "JavaScript/TypeScript code for the Worker"},
                "bindings": {"type": "array", "description": "KV/R2 bindings", "optional": True}
            },
        ...
        self.register_tool(ToolDefinition(
            ...
            parameters={
                ...
                "files": {"type": "object", "description": "Files to deploy (path: content mapping)"},
                "env_vars": {"type": "object", "description": "Environment variables", "optional": True}
            },
        ...
        self.register_tool(ToolDefinition(
            ...
            parameters={
                ...
                "customer_id": {"type": "string", "description": "Customer ID", "optional": True}
            },
        ...
        self.register_tool(ToolDefinition(
            ...
            parameters={
                "sport": {"type": "string", "description": "Sport type", "default": "BASKETBALL"},
        ...
        self.register_tool(ToolDefinition(
            ...
            parameters={
                ...
                "destination_blob_name": {"type": "string", "description": "Destination path in bucket"}
            },
    ...
    async def execute_tool(
        ...
        try:
            ...
            if tool.handler:
                ...
                return ToolResult(
                    success=False,
                    error="Tool has no handler implementation"
                )
    ...
    async def _shell_execute(self, args: Dict, context: Dict) -> Dict:
        ...
        try:
            ...
            return {"stdout": "", "stderr": f"Invalid command: {exc}", "returncode": 1, "success": False}
    ...
    async def _web_search(self, args: Dict, context: Dict) -> Dict:
        ...
        async with httpx.AsyncClient() as client:
            ...
            if response.status_code != 200:
                raise ValueError(f"SERP API request failed ({response.status_code}): {response.text}")
    ...
    async def _draftkings_get_odds(self, args: Dict, context: Dict) -> Dict:
        ...
        result = await draftkings.get_odds(
            sport=args.get("sport", "BASKETBALL"),
            league=args.get("league", "NBA")
        )
        if not result.success:
            raise ValueError(result.error)
        return result.data
